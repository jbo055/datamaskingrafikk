...
function initBuffers(gl) {
    ...
    let color = {red: 0.0, green: 0.45, blue: 0.9, alpha: 1.0}
    let colorArray = [];    //Merk!
    //Samme farge på alle sider:
    for (let i = 0; i < 36; i++) {
        colorArray.push(color.red, color.green, color.blue, color.alpha);
    }
    // Pakker colorArray inn i et Float32Array-objekt:
...
function draw(gl, baseShader, buffers) {
	...
	connectColorAttribute(gl, baseShader, buffers.color);
