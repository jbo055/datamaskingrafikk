...
function drawSphere(renderInfo, camera) {
	...
	// Kople posisjon og farge-attributtene til tilhørende buffer:
	connectPositionAttribute(gl, renderInfo.diffuseLightShader, renderInfo.sphereBuffers.position);
	connectNormalAttribute(gl, renderInfo.diffuseLightShader, renderInfo.sphereBuffers.normal);
