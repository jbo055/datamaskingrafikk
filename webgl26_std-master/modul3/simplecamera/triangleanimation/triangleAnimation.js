...
export function main() {
	...
	const renderInfo = {
		...
		animation: {    //Holder på animasjonsinfo:
			angle: 0,
			rotationSpeed: 60   //Betyr: trekanten roterer 60 grader per sekund, dvs. en hel rotasjon tar 6 sekunder.
		}
	};
...
function draw(currentTime, renderInfo, camera) {
	...
	let baseShader = renderInfo.baseShader;
    ...
    // Tegn!
    gl.drawArrays(gl.TRIANGLES, 0, renderInfo.buffers.vertexCount);
}